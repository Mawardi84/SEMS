...
export const initialData: SEMSData = {
  ...
  lpj: {
    ...
    status: "DRAFT",
    isReconciled: false,
    reconciliationNotes: "Menunggu penyelesaian rekapitulasi nota belanja dan sisa saldo kas tunai.",
    ...
    sections: [
      ...
      },
      {
        ...
        sequence: 4,
        status: "DRAFT",
        notes: "Memuat rekapitulasi penerimaan iuran RT/donatur, belanja riil panitia per seksi, dan kuitansi pembayaran.",
        createdAt: "2026-07-02T15:00:00.000Z",
        updatedAt: "2026-07-02T15:00:00.000Z"
      },
      {
        ...
        sectionType: "E",
        sectionCode: "E",
        sectionTitle: "Perubahan Anggaran",
        responsibleRole: "BENDAHARA",
        presenterRole: "BENDAHARA",
        presenterNameSnapshot: "Bendahara Panitia",
        sequence: 5,
        status: "SIAP",
        notes: "Memuat rekapitulasi dokumen Perubahan Anggaran (PA) dan Realokasi Antar Pos (RA) yang telah disahkan.",
        createdAt: "2026-07-02T15:00:00.000Z",
        updatedAt: "2026-07-02T15:00:00.000Z"
      },
      {
        ...
        sectionType: "F",
        sectionCode: "F",
        sectionTitle: "Rekonsiliasi Keuangan",
        responsibleRole: "BENDAHARA",
        presenterRole: "BENDAHARA",
        presenterNameSnapshot: "Bendahara Panitia",
        sequence: 6,
        status: "DRAFT",
        notes: "Memuat pencocokan buku kas, validitas bukti nota, perhitungan saldo sisa kas, dan serah terima saldo ke kas RW.",
        createdAt: "2026-07-02T15:00:00.000Z",
        updatedAt: "2026-07-02T15:00:00.000Z"
      },
      {
