...
export const initialData: SEMSData = {
  ...
  rkba: [
    ...
    },
    {
      ...
      isLockedBaseline: true,
      notes: "Belum dibelanjakan (Pagu Rp 1.500.000)",
      dateAdded: "2026-07-02"
    },
    {
      id: "rkba-11",
  ...
  notulensi: [
    {
      ...
      actionItems: [
        { id: "ai_0", task: "Negosiasi harga vendor sound, tratak, dan grup tarling", pic: "Perlengkapan", deadline: "10 Juli 2026" },
        { id: "ai_1", task: "Konfirmasi donasi konsumsi dan cetak kupon ke Pak RW", pic: "Ketua Panitia", deadline: "12 Juli 2026" }
      ],
    ...
    },
    {
      ...
      actionItems: [
        { id: "ai_2", task: "Realisasi belanja sesuai pagu final Rp 10.908.000", pic: "Bendahara", deadline: "23 Agustus 2026" }
      ],
    ...
    },
    {
      ...
      actionItems: [
        { id: "ai_3", task: "Cetak dan jilid Buku LPJ Master lengkap dengan lampiran nota & voucher", pic: "Sekretaris & Bendahara", deadline: "28 Agustus 2026" },
        { id: "ai_4", task: "Serah terima sisa saldo kas ke Kas RW 04", pic: "Ketua Panitia & Bendahara", deadline: "30 Agustus 2026" }
      ],
